...
/**
 * @brief Find the distance from any point on the nucleus to all points in the
 * cell
 *
 ...
 *        Note: This method assumes an equal force is exerted on all points on
 ...
 * @param cell 2D array where 1 is the cell and 0 is everything else
 * @param nucleus 2D array where 1 is the nucleus and 0 is everything else
 * @param force 2D array containing the force exerted on the nucleus due to each
 * pixel
 *
 * @return 2D double array of the force on each pixel on nucleus
 */
...
/**
 * @brief Find the force on the nucleus due to the pixels with applied force
 * using the layer removal method
 *
 * @param cell 2D array where 1 is the cell and 0 is everything else
 * @param nucleus 2D array where 1 is the nucleus and 0 is everything else
 * @param force 2D array containing the force exerted on the nucleus due to each
 ...
 * @param force 2D array of the force exerted on each pixel on the outer surface
 * of the nucleus
 *
